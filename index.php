...
<html lang="fr-FR" class="no-js">
	<head>
	  ...
	  <meta itemprop="birthDate" content="August 26, 1994">
	  <meta itemprop="jobTitle" content="CEO of T2isoft">
	  <meta itemprop="email" content="contact@karlkelleoglu.com">
	  <meta itemprop="url" content="http://www.karlkelleoglu.com">
	  <meta itemprop="memberOf" content="T2isoft">
	  <meta itemprop="image" content="http://karlkelleoglu.com/assets/photo.jpg">
	  <span itemprop="name">
    <link itemprop="sameAs" href="https://github.com/t2isoft">
    <link itemprop="sameAs" href="https://www.codeur.com/-t2isoft">
    <link itemprop="sameAs" href="https://www.facebook.com/karl.kelleoglu">
    <link itemprop="sameAs" href="https://www.linkedin.com/in/karlkelleoglu">
    <link itemprop="sameAs" href="https://twitter.com/t2isoft">
    <!--<link itemprop="sameAs" href="https://plus.google.com/103377602465276321204/posts">Karl Kelleoglu</span> is the CEO of T2isoft Inc.-->
	</div>
		...
		Title and Meta Tags
		=============================================== -->
		<title>Karl Kelleoglu | Portfolio</title>
		<meta name="description" content="Je suis un entrepreneur français ayant fait des études en ingénieurie informatique est travaillant avec plusieurs partenaires situées en belgique, suisse, maroc etc..">
		...
		<META NAME="Identifier-URL" CONTENT="www.karlkelleoglu.com">
		<META NAME="Keywords" CONTENT="Portfolio, karl kelleoglu, Création de site internet, création d'application mobile, Création de site web, Référencement">
		<META NAME="Publisher" CONTENT="T2isoft">
		<META NAME="Robots" CONTENT="all">
		<META NAME="GOOGLEBOT" CONTENT="NOARCHIVE">
		<META http-equiv="Content-Type"	content="text/html;charset=utf-8">
		<META http-equiv="Content-Language" content="fr">
		<META http-equiv="Refresh"	content="300; URL=http://www.karlkelleoglu.com">
	...
	<body data-spy="scroll" data-target="#main-nav" data-offset="200">
		...
		<div id="main-nav" class="navbar navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<!-- ======= LOGO ========-->
					<a class="navbar-brand scrollto" href="#home">Karl Kelleoglu<br><span>Entrepreneur / Développeur</span></a>
					<!-- <a class="navbar-brand scrollto ir-logo" href="#">DesignPandr<br><span>UI Designer</span></a> -->
				...
				<div id="site-nav" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a href="#services" class="scrollto">Mes services</a>
						</li>
						<li>
		...
		<section id="services">
			...
			<div class="container">
				...
				<h1 class="section-title scrollimation scale-in">Mes <span>Services</span> <i class="icon-wrench"></i></h1>
				...
				<div class="row services scrollimation fade-left">
					...
					<div class="col-md-3 details">
						<p>Vous avez besoin d'aide pour la gestion d'un de vos projets, redaction de cahier des charges, analyse fonctionnel, users case, la mise en place d'itil ou de la méthode agile.</p>
					</div>
					<div class="col-md-3 text-center">
					...
					<div class="col-md-3 details">
						<p>Vous souhaitez crée votre site web, une application web qui permettrait à votre société de gagner en chiffre d'affaire ou tous simplement de maintenir un projet existant et de l'améliorer. Je suis force de proposition.</p>
					</div>
				</div><!--End row (top) -->
				...
				<div class="row services bottom-row scrollimation fade-right">
					<div class="col-md-3 text-center col-md-push-3">
						<h2>Seo</h2>
						<a href="#fakelink" class="icon"><i class="icon-star"></i></a>
					</div>
					<div class="col-md-3 details col-md-pull-3">
						<p>Vous avez un site internet ou simplement une société et vous voulez gagner en visibilité et en part de marché à travers le plus grand marché du monde à savoir internet.</p>
					</div>
					<div class="col-md-3 text-center  col-md-push-3">
						<h2>Application mobile</h2>
						<a href="#fakelink" class="icon"><i class="icon-mobile-phone"></i></a>
					</div>
					<div class="col-md-3 details  col-md-pull-3">
						<p>Vous souhaitez crée une application mobile et vous trouvez que les prix du marché sont excessif. Vous souhaiter une application sur mesure pour gagner une nouvelle clientèle.</p>
					</div>
				</div><!--End row (bottom)-->
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-4 col-sm-offset-1 scrollimation fade-right">
						<img class="img-responsive img-circle img-center" src="assets/photo.jpg" alt="">
					</div>
			...
			<div class="container">
				...
				<div class="row skills">
					...
					<div class="col-sm-6 col-md-3 text-center">
						...
						<h2 class="text-center">Gestion de projet</h2>
					</div>
					<div class="col-sm-6 col-md-3 text-center">
						<span class="chart" data-percent="70"><span class="percent">70</span></span>
						<h2 class="text-center">Création de site internet</h2>
					</div>
					<div class="col-sm-6 col-md-3 text-center">
					...
					<div class="col-sm-6 col-md-3 text-center">
						...
						<h2 class="text-center">Application mobile</h2>
					</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-5 contact-info scrollimation fade-right">
						...
						<address>
							Karl KELLEOGLU<br>
							8 Rue gaston appert<br>
							Villeneuve la garenne, 92390<br>
							contact@karlkelleoglu.com<br>
							06-59-98-44-86
						</address>
					...
					<form id="contact-form" class="col-sm-7 scrollimation fade-left" action="contact.php" method="post" novalidate>
						...
						<div class="form-group">
						  ...
						  <div class="controls">
							<i class="icon-user"></i>
							<input id="contact-name" name="contactName" placeholder="Nom" class="form-control input-lg requiredField" type="text" data-error-empty="Please enter your name">
						  </div>
						</div><!-- End name input -->
						...
						<div class="form-group">
						  ...
						  <div class=" controls">
							...
							<input id="contact-mail" name="email" placeholder="Mail" class="form-control input-lg requiredField" type="email" data-error-empty="Please enter your email" data-error-invalid="Invalid email address">
						  </div>
						</div><!-- End email input -->
						...
						<div class="form-group">
						  <label class="control-label" for="contact-message">Message</label>
							<div class="controls">
								...
								<textarea id="contact-message" name="comments"  placeholder="Message" class="form-control input-lg requiredField" rows="5" data-error-empty="Please enter your message"></textarea>
							</div>
						</div><!-- End textarea -->
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-6 left-col">
						<h1 class="small-logo">Karl KELLEOGLU<br><span>Chef de projet / Développeur</span></h1>
						<ul class="footer-nav">
						...
						</SCRIPT>  <a	href="http://t2isoft.com/">T2isoft.com</a>



															</br>Numéro SIREN / SIRET : 80143037200012
														</p>
